...
include('../header.php'); ?>
<div id="pagecontent">
  <nav id="breadcrumbs"><a href="/">Home</a> :: <a href="/products.php">Products</a> :: <a href="/captiva/">Captiva Capture</a> :: <a href="/captiva/capabilities.php">Capabilities</a> :: <a href="/captiva/document_classification.php">Document Classification</a> </nav><!-- /#breadcrumbs  -->
...
<div id="sections" class="row">
    <a data-tab="what" class="box" href="#what" id="whattab"><i class="material-icons">arrow_drop_down</i><span>What is it?</span></a>
...
<div class="panel" id="how_work">
  ...
  <div class="row">      
        <img class="capabilities" src="doc_class_work.png" alt="How does it work" title="" align="center" />
  </div>
