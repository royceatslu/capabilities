...
<body>
    <h2 style="text-align:center">Click on Image to Enlarge</h2>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="column">
      <img class="demo cursor" src="../images/img_nature_wide.jpg" style="width:100%" onclick="currentSlide(1)" alt="Image Name 1">
    </div>
    <div class="column">
      <img class="demo cursor" src="../images/img_fjords_wide.jpg" style="width:100%" onclick="currentSlide(2)" alt="Image Name 2">
    </div>
    <div class="column">
      <img class="demo cursor" src="../images/img_mountains_wide.jpg" style="width:100%" onclick="currentSlide(3)" alt="Image Name 3">
    </div>
    <div class="column">
      <img class="demo cursor" src="../images/img_lights_wide.jpg" style="width:100%" onclick="currentSlide(4)" alt="Image Name 4">
    </div>
  </div>
</div>


<!-- Adding jQuery for image enlargement-->
